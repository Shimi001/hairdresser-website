function Hero() {
    return (
        <>
            <section id="hero" className="flex flex-col px-8 pt-10 h-[85vh] justify-center tracking-wide bg-linear-to-b from-blue-400 via-indigo-400 to-violet-400 text-white">
